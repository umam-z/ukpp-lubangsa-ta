          ...
          <div class="col-md-4">
             ...
             <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Add Pendidikan</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="/pendidikan">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="inputNmae">Lembaga</label>
                    <input name="lembaga" type="text" class="form-control" id="inputNmae" placeholder="Enter...">
                  </div>
                  <div class="form-group">
                    <label for="inputStaff">Staff</label>
                    <input name="staff" type="text" class="form-control" id="inputStaff" placeholder="Enter...">
                  </div>
                  <div class="form-group">
                    <label for="inputEmail">Email</label>
                    <input name="email" type="email" class="form-control" id="inputEmail" placeholder="Enter...">
                  </div>
                </div>
                <!-- /.card-body -->
